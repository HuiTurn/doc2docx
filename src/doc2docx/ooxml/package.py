...
def _append_floating_picture(
    ...
    *,
    ...
    anchor = ET.SubElement(
        ...
        _qn(WP_NS, "anchor"),
        {
            "distT": str(max(picture.wrap_dist_top_emu, 0)),
            "distB": str(max(picture.wrap_dist_bottom_emu, 0)),
            "distL": str(max(picture.wrap_dist_left_emu, 0)),
            "distR": str(max(picture.wrap_dist_right_emu, 0)),
            "simplePos": "0",
